...
public class DividerDefault extends RecyclerView.ItemDecoration implements WrapConstants {
    ...
    public DividerDefault(WrapRecyclerView rv, Drawable dividerVertical, Drawable dividerHorizontal, int dividerDrawableSizeVertical, int dividerDrawableSizeHorizontal) {
        this.mLayoutManagerType = rv.getCurLayoutManagerType();
        ...
        initLayoutManagerType(rv.getLayoutManager());
    }
    ...
    private void initLayoutManagerType(RecyclerView.LayoutManager layoutManager) {
        switch (mLayoutManagerType) {
            ...
            case LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                ...
                break;
            default:
                this.mLayoutManagerType = LAYOUT_MANAGER_TYPE_LINEAR;
        }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        if (parent.getAdapter() != null && (null != mVerticalDividerDrawable || null != mHorizontalDividerDrawable)) {
    ...
    private void drawDividerDrawable(Canvas c, RecyclerView parent) {
        ...
        WrapRecyclerView curRV;
        if (parent instanceof WrapRecyclerView) {
            curRV = (WrapRecyclerView) parent;
            headersCount = curRV.getHeaderViewCount();
            footerCount = curRV.getFooterViewCount();
            itemViewCount = curRV.getAdapter().getItemCount() - headersCount - footerCount;
        } else {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (isHeadViewPos(headersCount, position) || isFooterViewPos(headersCount, footerCount, itemViewCount, position)) {
            ...
            switch (mLayoutManagerType) {
                ...
                case LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                    ...
                    if (mLayoutManagerType == LAYOUT_MANAGER_TYPE_GRID && position == (itemViewCount + headersCount - 1)) {
                    ...
                    if (mOrientation == OrientationHelper.HORIZONTAL) {
                        ...
                        if (isGridItemLayoutLastRow && !isGridItemLayoutLastColumn) {
                            horizontalLeft = 0;
                        }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        // set itemView
        if (mLayoutManagerType == LAYOUT_MANAGER_TYPE_GRID || mLayoutManagerType == LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
