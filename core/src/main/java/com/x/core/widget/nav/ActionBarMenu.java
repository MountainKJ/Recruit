...
public class ActionBarMenu implements OnClickListener {
	...
	private LinearLayout leftExtraLayout = null;
	...
	public void setViewAndListener(View v, OnActionBarItemSelectedListener listener) {
		...
		iconView = viewGroup.findViewById(R.id.action_bar_icon_left);
		titleView = viewGroup.findViewById(R.id.action_bar_title);
		leftLayout = viewGroup.findViewById(R.id.action_bar_left_linear_layout);
		leftExtraLayout = viewGroup.findViewById(R.id.action_bar_left_extra_layout);
		borderView = viewGroup.findViewById(R.id.action_bar_border);
		if (this.getIcon() > 0) {
